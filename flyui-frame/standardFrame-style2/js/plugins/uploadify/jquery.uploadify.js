...
(function($) {
    ...
    var handlers = {
        ...
        onDialogOpen: function() {
            ...
            this.queueData.errorMsg = '';//文件格式系统不支持，请选用其他格式类型的该文件!
        ...
        onSelect: function(file) {
            ...
            // modify by ddqian  此处判断存在异常。return 后，仍可执行上传操作
            // if (file.name.length > 100) {
            //     alert('文件"' + file.name + '" 名称过长');
            //     // fly.top.fly.tip('文件"' + file.name + '" 名称过长','danger');
            //     return false;
            // }
            ...
            var fileTitle = fileName = file.name;
            ...
            if (settings.itemTemplate == false) {
                ...
                //cancel 添加方法 $(\'#${instanceID}\').uploadify(\'cancel\', \'${fileID}\')

                settings.itemTemplate = '<div id="${fileID}" class="uploadify-queue-item">\
					<div class="cancel">\
						<a href="javascript:void(null)" data-id="" class="delete" title="删除">删除</a>\
					</div>\
					<div class="info"><span class="fileName" title="${fileTitle}">${fileName} (${fileSize})</span><span class="data"></span></div>\
