...
export default {
  ...
  methods: {
    renderIcon: function (h, icon, iconClass) {
      return icon === 'none' ? null : h(
        Icon,
        {
      ...
      // return icon ? h(
      //   'i',
      //   { attrs: { class: 'iconfont ' + icon + ' ' + iconClass } },
      // ) : null
    },
      ...
      return h(
        ...
        [
          h(
            ...
            [
              this.renderIcon(h, menu.icon, menu.iconClass, menu.type),
              h('span', [menu.name])
            ]
          )
        ]
    ...
    updateMenu () {
      ...
      if (breadcrumb && breadcrumb.length > 0) {
        this.selectedKeys = [breadcrumb[0].path]
      }
