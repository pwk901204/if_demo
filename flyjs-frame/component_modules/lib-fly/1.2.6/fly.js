...
Licensed under MIT
Author: huanzhang
Update: 2018-03-19 11:03:39 CST
*/
! function(e) {
  ...
  return (function e(t, n, r) {
    ...
    2: [
      function(_require, module, exports) {
        ...
        componentBinders.visible = Binder.extend({
          ...
          refresh: function() {
            var component = this.component,
              visible = this.bindings.visible.get() ? '' : "none";
            if (component.visible) {
              component.visible(visible);
            } else {
              (component.element || component.wrapper).style.display = visible;
            }
          }
        });
        ...
        componentBinders.invisible = Binder.extend({
          ...
          refresh: function() {
            var component = this.component,
              invisible = this.bindings.invisible.get() ? "none" : '';
            if (component.visible) {
              component.visible(visible);
            } else {
              component.wrapper.style.display = invisible;
            }
          }
        });
        ...
        componentBinders.attr = Binder.extend({
          ...
          refresh: function(key) {
            this.component.options.set(key, this.bindings.attr[key].get());
          }
        });
        ...
        componentBinders.attr = Binder.extend({
          ...
          refresh: function(key) {
            this.component[key] && this.component[key](this.bindings.attr[key].get());
          }
        });
    ...
    3: [
      function(_require, module, exports) {
        ...
        fly.component = function(MyComponent, name) {
          return fly.ui[(name || MyComponent.fn.name).toLowerCase()] = MyComponent;
        };
    ...
    6: [
      function(_require, module, exports) {
        ...
        var formatDate = function(date, format) {
          ...
          var year = format.match(/(y+)/g);
          if (year && year[0]) {
            reg = year[0];
            format = format.replace(reg, (date.getFullYear() + '').substr(4 - reg.length));
          }
          ...
          for (reg in regExps) {
            var regExp = new RegExp('(' + reg + ')', 'g'),
              ...
              real;
            if (match && match) {
              real = match[0].length == 1 ? temp : ('00' + temp).substr(temp.length);
              format = format.replace(match[0], real);
            }
          }
    ...
    7: [
      function(_require, module, exports) {
        ...
        jQuery.parseHTML = function(data) {
          ...
          return jQuery.merge([], parsed.children || parsed.childNodes);
        };
    ...
    12: [
      function(_require, module, exports) {
         ...
         * @type {Function}
         */
        support.mutationobserver = root.MutationObserver ||
          root.WebKitMutationObserver || null;
        ...
        support.touch = (
          ...
          (root.DocumentTouch && document instanceof root.DocumentTouch) || //非IE
        ...
        support.browser = (function() {
          ...
          if (userAgent.indexOf("Opera") > -1) {
            ...
            browser.safari = 1;
          } else if (!!root.ActiveXObject || "ActiveXObject" in window) {
        ...
        support.os = (function() {
          ...
          var funcs = [
            ...
            function() { //wechat
              var wechat = userAgent.match(/(MicroMessenger)\/([\d\.]+)/i);
              if (wechat) { //wechat
                os.wechat = {
            ...
            function() { //android
              ...
              if (android) {
                ...
                os.isBadAndroid = !(/Chrome\/\d/.test(navigator.appVersion));
              }
