<template>
  <div>
    <v-chart :forceFit="true"
      ...
      <v-guide type="arc"
               :zIndex="1"
               :start="arcGuideLowStart"
               :end="arcGuideLowEnd"
               :vStyle="arcGuideLowStyle"></v-guide>
      <v-guide type="arc"
               :zIndex="1"
               :start="arcGuideMidStart"
               :end="arcGuideMidEnd"
               :vStyle="arcGuideMidStyle"></v-guide>
      <v-guide type="arc"
               :zIndex="1"
               :start="arcGuideHighStart"
               :end="arcGuideHighEnd"
               :vStyle="arcGuideHighStyle"></v-guide>
      <v-guide type="html"
               :position="htmlGuidePosition"
               :html="htmlGuideHtml"></v-guide>
    </v-chart>
  </div>
</template>
